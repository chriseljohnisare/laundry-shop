...
--
-- Host: 127.0.0.1    Database: laundry_shop
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `status` enum('received','washing','drying','folding','ready','completed','returned') NOT NULL DEFAULT 'received',
...
CREATE TABLE `payments` (
  ...
  `type` enum('cash','card','ewallet') NOT NULL DEFAULT 'cash',
  `status` enum('partial','full') NOT NULL DEFAULT 'partial',
...
-- Dump completed on 2026-04-02 13:52:20
