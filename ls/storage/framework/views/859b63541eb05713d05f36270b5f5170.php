...
<body class="antialiased">
        ...
        <div class="max-w-7xl mx-auto px-6 w-full flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="bg-indigo-600 px-6 py-2 rounded-xl text-sm font-bold">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-sm font-semibold text-slate-400">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-slate-950 px-6 py-2 rounded-xl text-sm font-bold">Get Started</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-slate-950 py-20 border-t border-white/5 text-center">
        <p class="text-slate-500 text-sm font-bold tracking-widest uppercase">&copy; <?php echo e(date('Y')); ?> LaundryPro Global</p>
    </footer>
</body>
</html>
<?php /**PATH C:\a\ls\ls\resources\views/components/public-layout.blade.php ENDPATH**/ ?>