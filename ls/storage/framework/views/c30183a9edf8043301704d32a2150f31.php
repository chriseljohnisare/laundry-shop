...
<?php $component->withAttributes([]); ?>
    <div class="mb-8">
        <a href="<?php echo e(route('admin.customers.index')); ?>" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 transition flex items-center mb-2">
        ...
        <p class="text-gray-500 font-medium">Updating information for <?php echo e($customer->name); ?>.</p>
    </div>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_number" value="<?php echo e(old('contact_number', $customer->contact_number)); ?>" required 
                            class="block w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-bold text-gray-900 focus:ring-2 focus:ring-indigo-500 transition-all">
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea name="address" rows="3" required 
                            class="block w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-medium text-gray-900 focus:ring-2 focus:ring-indigo-500 transition-all resize-none"><?php echo e(old('address', $customer->address)); ?></textarea>
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
<?php /**PATH C:\a\laundry-shop\laundry-laravel\resources\views/admin/customers/edit.blade.php ENDPATH**/ ?>