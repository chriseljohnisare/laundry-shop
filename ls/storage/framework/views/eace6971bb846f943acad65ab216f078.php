    ...
    <div class="receipt-container max-w-lg mx-auto bg-white border border-slate-200 shadow-sm p-8 md:p-12 rounded-3xl">
        ...
        <div class="flex justify-between items-start mb-10 text-sm">
            <div>
                ...
                <p class="font-black text-slate-900">#<?php echo e($order->receipt_number); ?></p>
            </div>
            <div class="text-right">
                <p class="text-slate-400 font-bold uppercase text-[10px] tracking-widest mb-1">Date Issued</p>
                <p class="font-black text-slate-900"><?php echo e($order->created_at->format('M d, Y')); ?></p>
            </div>
        </div>
        ...
        <div class="mb-10 bg-slate-50 rounded-2xl p-6 border border-slate-100">
            ...
            <p class="text-base font-black text-slate-900 mb-1"><?php echo e($order->customer->name); ?></p>
            <p class="text-xs font-bold text-slate-500 mb-1"><?php echo e($order->customer->contact_number); ?></p>
            <p class="text-xs font-medium text-slate-400 leading-relaxed"><?php echo e($order->customer->address); ?></p>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="text-sm">
                    <tr class="border-b border-slate-50">
                        <td class="py-6">
                            <p class="font-black text-slate-900"><?php echo e($order->service->name); ?></p>
                            <p class="text-xs font-medium text-slate-400 mt-1">Professional Care</p>
                        </td>
                        <td class="py-6 text-right font-bold text-slate-600">
                            <?php echo e($order->weight_kg); ?>kg &times; $<?php echo e(number_format($order->price_per_kg, 2)); ?>
        ...
        <div class="space-y-4 border-t border-slate-100 pt-8 mb-10">
            <div class="flex justify-between items-center text-sm">
                ...
                <span class="font-black text-slate-900">$<?php echo e(number_format($order->total_amount, 2)); ?></span>
            </div>
            <div class="flex justify-between items-center text-sm">
                <span class="text-slate-400 font-bold">Total Paid</span>
                <span class="font-black text-emerald-600">-$<?php echo e(number_format($order->paid_amount, 2)); ?></span>
            </div>
            <div class="flex justify-between items-center pt-4 border-t border-slate-950">
                ...
                <span class="text-3xl font-black text-slate-950">$<?php echo e(number_format(max(0, $order->total_amount - $order->paid_amount), 2)); ?></span>
            </div>
        </div>
        ...
        <div class="text-center">
            ...
            <div class="bg-slate-950 text-white py-2 rounded-xl text-[10px] font-black uppercase tracking-[0.3em]">
                <?php echo e($order->payment_status === 'full' ? 'Payment Confirmed' : 'Payment Pending'); ?>
...
<?php /**PATH C:\a\laundry-shop\laundry-laravel\resources\views/admin/orders/print.blade.php ENDPATH**/ ?>