<x-admin-layout>
    <div class="mb-8">
        ...
        <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Add New Service</h2>
        <p class="text-gray-500 font-medium">Define a new professional laundry offering.</p>
    </div>
                ...
                <div class="p-8 lg:p-10 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required 
                                ...
                                placeholder="e.g., Luxury Silk Wash">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" name="price_per_kg" id="price_per_kg" value="{{ old('price_per_kg') }}" required 
                                class="block w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-bold text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                placeholder="0.00">
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" 
                            class="block w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl text-sm font-medium text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all resize-none"
                            placeholder="Detail what this service includes..."></textarea>
